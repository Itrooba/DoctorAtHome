...
const headCells = [
  ...
  { id: 'email', numeric: true, disablePadding: false, label: 'Service' },
...
export default function OnlineApp() {
  ...
  const getinfo = async()=>{
    ...
    await axios.get('http://localhost:5000/api/auth/OnlinePatientAppointment/' + email)
          ...
          >
            ...
            {data.map(function(rows, i) {
                    ...
                    >
                      ...
                      <TableCell align="left" width="150">{rows.Service}</TableCell>
                      <TableCell align="left" width="150">{rows.Status}</TableCell>
                      <TableCell align="left" width="100"><Button variant="contained"  color="primary" href={"/room/" + name + "/" + email + "/" + rows.doc_id }>
                      Call
                    </Button></TableCell>
                    <TableCell align="left" width="200"><Button variant="contained"  color="primary" href={"/view/" + name +"/" + email +"/" + rows.doc_id}>
                      View Record
                    </Button></TableCell>
                    </TableRow>
                    )})}
